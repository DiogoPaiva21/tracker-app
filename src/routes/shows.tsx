...
import { getPopularShows } from '@/lib/tmdb/handlers/home'

const getPopularShowsData = createServerFn({ method: 'GET' }).handler(async () => {
...
const NEW_EPISODES: MediaCardProps[] = [
  {
    id: 'ne1',
    title: "X-Men '97",
    image: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/k8yARbD9iYn2nRX2HvsopfKDN2r.jpg',
    rating: 8.7,
    year: 2024,
    type: 'show',
    episode: 'S01 E05',
  ...
  },
  {
    id: 'ne2',
    title: 'Tokyo Vice',
    image: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/g5WwAIfQ0H0yqg0j6xVb1r7M0p3.jpg',
    rating: 8.2,
    year: 2022,
    type: 'show',
    episode: 'S02 E10',
  ...
  },
  {
    id: 'ne3',
    title: 'Invincible',
    image: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/dMOzdp1Nq3n9B4f2U8eX0uW6jGZ.jpg',
    rating: 8.7,
    year: 2021,
    type: 'show',
    episode: 'S02 E08',
  ...
  },
  {
    id: 'ne4',
    title: 'The Boys',
    image: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/stTEycfG9928HYGEISBFaG1ngjM.jpg',
    rating: 8.4,
    year: 2019,
    type: 'show',
    episode: 'S04 E03',
  ...
  },
  {
    ...
    image: 'https://image.tmdb.org/t/p/w600_and_h900_bestv2/z2yhl2wMACENh8x167b2zG5H485.jpg',
    rating: 8.4,
    year: 2022,
    type: 'show',
    episode: 'S02 E01',
